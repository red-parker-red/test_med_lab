                ...
                <div className="signup-form">
                    <form method="POST" onSubmit={register}>
                        <div className="form-group">
                            ...
                            {showerr && <div className="err" style={{ color: 'red' }}>{showerr[0].msg}</div>}
                        </div>
                        <div className="form-group">
                            ...
                            {showerr && <div className="err" style={{ color: 'red' }}>{showerr[1].msg}</div>}
                        </div>
                        <div className="form-group">
                            ...
                            {showerr && <div className="err" style={{ color: 'red' }}>{showerr[2].msg}</div>}
                        </div>
                        <div className="form-group">
                            ...
                            {showerr && <div className="err" style={{ color: 'red' }}>{showerr[3].msg}</div>}
                        </div>
